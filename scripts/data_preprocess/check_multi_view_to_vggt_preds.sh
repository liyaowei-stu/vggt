...
python ic_custom_data_prepare/check_multi_view_to_vggt_preds.py \
    --image_path data/navi/navi_v1.5/soldier_wood_showpiece/multiview-01-pixel_4a/masked_images \
